...
import {
  ServicosPage,
  MapeamentoProcessosPage,
  EstrategiaEmpresarialPage,
  GestaoFinanceiraPage,
  CaptacaoClientesPage,
  EmpresasJunioresPage,
  SERVICES,
  SERVICE_IMAGES,
} from "../services";
import type { Page } from "../services";
import { HEADING, SERIF, BODY } from "../services";
    ...
    <footer className="bg-primary text-white">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {[
              { label: "Otimização de Processos", page: "mapeamento-processos" },
              { label: "Estratégia Empresarial", page: "estrategia-empresarial" },
              { label: "Gestão Financeira", page: "gestao-financeira" },
              { label: "Captação de Clientes", page: "captacao-clientes" },
              { label: "Empresas Juniores", page: "empresas-juniores" },
            ].map((item) => (
              <button
                key={item.page}
...
// ServicosPage → src/services/ServicosPage.tsx


// MapeamentoProcessosPage → src/services/MapeamentoProcessosPage.tsx
...
// EstrategiaEmpresarialPage → src/services/EstrategiaEmpresarialPage.tsx
    ...
    >
      ...
      <main>
        ...
        {page === "estrategia-empresarial" && (
          <EstrategiaEmpresarialPage setPage={navigate} />
        )}
        {page === "gestao-financeira" && (
          <GestaoFinanceiraPage setPage={navigate} />
        )}
        {page === "captacao-clientes" && (
          <CaptacaoClientesPage setPage={navigate} />
        )}
        {page === "empresas-juniores" && (
          <EmpresasJunioresPage setPage={navigate} />
        )}
